...
import 'package:riverpod_practice/api.dart';
...
class Home extends ConsumerWidget {
  ...
  Widget build(BuildContext context,WidgetRef ref) {
    ...
    return  Scaffold(
        appBar: AppBar(
        title: Text('Future Provider Api',style: TextStyle(
      ...
      body: Center(
        child: Consumer(builder: (context,ref,child){
          final provider = ref.watch(postApiProvider);
                  ...
                  itemBuilder: (context,index){
                    ...
                    return Card(
                      ...
                      title: Text(item.title.toString()),
                        subtitle: Center(child: Text(item.id.toString())),
                                        ),
                    ) ;
              }),
